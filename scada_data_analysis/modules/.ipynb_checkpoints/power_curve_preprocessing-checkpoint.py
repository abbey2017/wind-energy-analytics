...
class PowerCurveFiltering:
    ...
    def __init__(self, turbine_label, windspeed_label, power_label, data=None,
                 cutin_speed=3, bin_interval=0.5, z_coeff=2, filter_cycle=5, return_fig=False):
        """
    ...
    def process(self):
        ...
        if self.return_fig:
            ...
            for turbine_name in turbine_names:
                ...
                fname = f"examples\images\{turbine_name}_pc.png"
                plt.savefig(fname)
